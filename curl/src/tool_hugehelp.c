 ...
 * Generation time: Thu Aug 24 17:19:53 2017
 */
#ifdef USE_MANUAL
...
"              (HTTP) Similar to [4m-F,[24m [4m--form[24m except that the  value  string  for\n"
"              the named parameter is used literally. Leading '@' and '<' char-\n"
"              acters, and the ';type=' string in the  value  have  no  special\n"
, stdout);
 fputs(
"              meaning.  Use  this  in  preference to [4m-F,[24m [4m--form[24m if there's any\n"
"              possibility that the string value may accidentally  trigger  the\n"
"              '@' or '<' features of [4m-F,[24m [4m--form[24m.\n"
"\n"
...
"              if  specify  [4m-x,[24m  [4m--proxy[24m  option. That is [1mNO_PROXY=direct.exam-[0m\n"
"              [1mple.com  curl  -x  http://proxy.example.com  http://direct.exam-[0m\n"
"              [1mple.com     [22maccesses    the    target    URL    directly,    and\n"
, stdout);
 fputs(
"              [1mNO_PROXY=direct.example.com  curl  -x   http://proxy.example.com[0m\n"
"              [1mhttp://somewhere.example.com  [22maccesses  the  target  URL through\n"
"              proxy.\n"
"\n"
