...
std::string filesResource::toJSON() {
    ...
    writer.StartObject();
    writer.Key("width");
    writer.Int(this->imageMediaMetadata.width);
    writer.Key("height");
    writer.Int(this->imageMediaMetadata.height);
    writer.Key("rotation");
    writer.Int(this->imageMediaMetadata.rotation);
    writer.Key("location");
    writer.StartObject();
    writer.Key("latitude");
    writer.Double(this->imageMediaMetadata.location.latitude);
    writer.Key("longitude");
    writer.Double(this->imageMediaMetadata.location.longitude);
    writer.Key("altitude");
    writer.Double(this->imageMediaMetadata.location.altitude);
    writer.EndObject();
    writer.Key("time");
    writer.String(this->imageMediaMetadata.time.c_str());
    writer.Key("cameraMake");
    writer.String(this->imageMediaMetadata.cameraMake.c_str());
    writer.Key("cameraModel");
    writer.String(this->imageMediaMetadata.cameraModel.c_str());
    writer.Key("exposureTime");
    writer.Double(this->imageMediaMetadata.exposureTime);
    writer.Key("aperture");
    writer.Double(this->imageMediaMetadata.aperture);
    writer.Key("flashUsed");
    writer.Bool(this->imageMediaMetadata.flashUsed);
    writer.Key("focalLength");
    writer.Double(this->imageMediaMetadata.focalLength);
    writer.Key("isoSpeed");
    writer.Int(this->imageMediaMetadata.isoSpeed);
    writer.Key("meteringMode");
    writer.String(this->imageMediaMetadata.meteringMode.c_str());
    writer.Key("sensor");
    writer.String(this->imageMediaMetadata.sensor.c_str());
    writer.Key("exposureMode");
    writer.String(this->imageMediaMetadata.exposureMode.c_str());
    writer.Key("colorSpace");
    writer.String(this->imageMediaMetadata.colorSpace.c_str());
    writer.Key("whiteBalance");
    writer.String(this->imageMediaMetadata.whiteBalance.c_str());
    writer.Key("exposureBias");
    writer.Double(this->imageMediaMetadata.exposureBias);
    writer.Key("maxApertureValue");
    writer.Double(this->imageMediaMetadata.maxApertureValue);
    writer.Key("subjectDistance");
    writer.Int(this->imageMediaMetadata.subjectDistance);
    writer.Key("lens");
    writer.String(this->imageMediaMetadata.lens.c_str());
    writer.EndObject();
    writer.Key("videoMediaMetadata");
    writer.StartObject();
    writer.Key("width");
    writer.Int(this->videoMediaMetadata.width);
    writer.Key("height");
    writer.Int(this->videoMediaMetadata.height);
    writer.Key("durationMillis");
    writer.Int64(this->videoMediaMetadata.durationMillis);
    writer.EndObject();
